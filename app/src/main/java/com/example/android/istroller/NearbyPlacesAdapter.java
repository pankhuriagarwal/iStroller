...
public class NearbyPlacesAdapter extends ArrayAdapter<NearbyPlacesData> {
    ...
    public NearbyPlacesAdapter(Activity context, ArrayList<NearbyPlacesData> NearbyPlaces) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.listviewproperties, parent, false);
        }

        // Get the {@link AndroidFlavor} object located at this position in the list
        NearbyPlacesData currentPlace = getItem(position);
...
//        imageView.setImageResource(image);
        ...
        int distance = currentPlace.getDistance();
        int dist = currentPlace.getDistance();
        int distKm=dist/1000;
        String distance1 = "Distance:  "+distKm + "Km";
